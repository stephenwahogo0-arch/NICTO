...
KEY_SCOPES = {
    "full_access": "Unrestricted access to all NIKTO capabilities, tools, and data",
...
class APIGateway:
    ...
    def create_key(self, name: str = "default", scope: str = "full_access", rate_limit: int = 1000) -> dict:
        ...
        return {
            ...
            "instructions": f"Use this API key with any OpenAI-compatible client by setting base_url to your NIKTO endpoint and api_key to '{api_key.key}'",
        }
    ...
    def generate_self_api_key(self) -> dict:
        result = self.create_key(name="NIKTO_SELF_GENERATED", scope="full_access", rate_limit=100000)
        result["message"] = "NIKTO has generated its own API key — use this to connect NIKTO to any external service, space, or application"
