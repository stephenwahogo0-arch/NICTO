...
class StagingSandbox:
    ...
    def __init__(self, base_dir: Optional[str] = None):
        self.base_dir = Path(base_dir or os.path.expanduser("~/.kyros/sandbox"))
    ...
    def promote_to_updates(self, module_rel_path: str) -> dict:
        ...
        return {
            ...
            "message": "Ready to apply. Please restart KYROS to apply the update.",
        }
