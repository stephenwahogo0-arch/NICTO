"""KYROS Safety system — activity auditing, abuse reporting, emergency/SOS, police cooperation, and safety lock."""
import json
import os
import hashlib
import time
...
from kyros.registration import UserRegistry
...
class PoliceCooperationMode:
    ...
    def export_for_law_enforcement(self, officer_name: str, badge_id: str,
        ...
        export_data["chain_of_custody"] = {
            "exported_by": "KYROS Police Cooperation Mode",
...
class SafetySystem:
    ...
    def run_privacy_cli(self) -> None:
        ...
        c = Console()
        c.print(Panel.fit(
            "[bold cyan]KYROS Privacy & Safety Center[/]\n\n"
        ...
        while True:
            ...
            if choice == "0":
                ...
                from kyros.privacy import get_privacy_policy
                ...
                from kyros.registration import RegistrationFlow
