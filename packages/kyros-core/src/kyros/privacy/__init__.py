"""KYROS Privacy Policy — full disclosure of data practices, user rights, and safety commitments."""
...
╔══════════════════════════════════════════════════════════════════╗
║                    KYROS PRIVACY POLICY                         ║
║                       Version {PRIVACY_POLICY_VERSION}                        ║
║                    Effective: {PRIVACY_POLICY_DATE}                    ║
╚══════════════════════════════════════════════════════════════════╝

At KYROS, your privacy and safety are our highest priorities.
...
────────────────────────────────────────────────────────────────
   ...
   c) SENSITIVE DATA WE DO NOT COLLECT:
      ...
      • Browsing history outside KYROS
...
────────────────────────────────────────────────────────────────
   ...
   • To improve KYROS's performance and reliability

   YOUR DATA IS NEVER:
   • Sold to third parties (KYROS is not a commercial product)
...
────────────────────────────────────────────────────────────────
   ...
   KYROS will only share your data in the following circumstances:
   ...
   c) FOR LAW ENFORCEMENT (POLICE COOPERATION):
      • KYROS includes a Police Cooperation Mode that, when
...
────────────────────────────────────────────────────────────────
   ...
   e) SAFETY LOCK:
      • Optional PIN protection for KYROS access
      • Prevents unauthorized use of your system
      • Locks automatically after inactivity

   f) CONTENT SAFETY:
      • KYROS monitors for potentially dangerous or illegal content
...
────────────────────────────────────────────────────────────────
   ...
   As a KYROS user, you have the following rights:
   ...
   e) RIGHT TO WITHDRAW CONSENT:
      ...
      • Core KYROS functionality will continue to work
...
────────────────────────────────────────────────────────────────
   ...
   • KYROS never transmits data over the network without explicit consent
...
────────────────────────────────────────────────────────────────
   ...
   • KYROS is not intended for users under 18 years of age
...
────────────────────────────────────────────────────────────────
    ...
    • This policy may be updated as KYROS evolves
...
────────────────────────────────────────────────────────────────
    ...
    • Emergency: Use the SOS feature in KYROS
...
────────────────────────────────────────────────────────────────
    ...
    BY USING KYROS, YOU ACKNOWLEDGE THAT YOU HAVE READ,
...
© {datetime.now().year} KYROS AI System. All rights reserved.
"""
...
def get_policy_summary():
    return """KYROS stores your data LOCALLY and ENCRYPTED. Key points:
