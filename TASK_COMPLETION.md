...
5. `packages/nikto-core/src/nikto/variants/heavyweight.py` - Updated docstring
6. `packages/nikto-core/src/nikto/variants/sonnet.py` - Updated docstring
7. `packages/nikto-core/src/nikto/variants/mythos.py` - Updated docstring and comments
8. `packages/nikto-cli/src/nikto_cli/main.py` - Updated variant help text
...
- `create_variant("nikto-denu")` for sonnet capabilities
- `create_variant("nikto-plus")` for mythos capabilities
